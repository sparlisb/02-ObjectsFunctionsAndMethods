...
def main():
    ...
    even_better_draw_circles(rg.Point(-200, 0), 100, 'blue', 5, 2)
...
def even_better_draw_circles(point, increase_size, color, thickness, number):
    turtle = rg.SimpleTurtle()
    ...
    for k in range(1, int(number) + 1):  # k becomes 1, 2, 3, ... 10
